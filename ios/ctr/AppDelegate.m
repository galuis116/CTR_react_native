...
- (BOOL)application:(UIApplication *)app openURL:(NSURL *)url options:(NSDictionary<UIApplicationOpenURLOptionsKey,id> *)options
{
  ...
  if (components == nil || components.queryItems == nil || ![components.scheme isEqual: @"ctrwidget"]) {
    return NO;
  }
  
  NSURLQueryItem *item = components.queryItems.firstObject;
  
  if (item == nil || ![@"action" isEqual:[item name]]) {
    return NO;
  }
  ...
  if (view != nil && [view isKindOfClass: [RCTRootView class]]) {
    RCTRootView *rootView = (RCTRootView *)view;
    rootView.appProperties = @{@"scene": [item value]};
  }
